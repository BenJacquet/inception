...
CHOSES A EXPLIQUER PENDANT LA SOUTENANCE :
- Comment fonctionnent Docker et docker-compose
- La difference entre une image utilisee avec ou sans docker-compose
- L'avantage de Docker par rapport a une VM
- Comment fonctionne un docker-network
...
MYSQL et MYSQLD :
https://stackoverflow.com/questions/25905657/its-mysql-or-mysqld